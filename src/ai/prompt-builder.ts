...
const PROMPT_HEADER = [
  ...
  '- TANGENT ("tiếp tuyến tại A", "tangent at A", "tangent vid A"): {"type":"tangent","at":"A","line":"Ax","circle":"O"} in CONSTRAINTS only — NEVER in constructions. If line name not given, invent second letter (e.g. "Dt").',
  ...
  '    ✗ median BM → midpoint(M,["B","C"])  WRONG: B is the from-vertex, never in "of"',
  '    ✓ median BM → midpoint(M,["A","C"])  CORRECT: opposite side to B is AC',
  ...
  '  MIDPOINT FORMAT: {"type":"midpoint","point":"M","of":[...two endpoints of OPPOSITE side...]}. WRONG: of:["A","BC"]. CORRECT for median BM: of:["A","C"].',
  ...
  '- EQUATION TARGET ("CM AC+BD=AB", "Prove AC+BD=AB"): use {"type":"equation","expr":"AC+BD=AB"} in targets. Never use statement for equations.',
  '- RIGHT ANGLE TARGET ("tam giác AOB vuông tại O", "triangle AOB is right-angled at O"): use {"type":"right_angle","at":"O","triangle":["A","O","B"]} in targets.',
  "",
...
export function buildGeometrySystemPrompt(): string {
  return [
    PROMPT_HEADER,
    "",
    "Example (multi-part problem with tangent, intersection point, perpendicular foot, midpoint target):",
    'input: "Cho (O) đường kính CD, tiếp tuyến tại C là Cx, E thuộc (O). Qua O kẻ đường ⊥ CE cắt Cx tại A. a) CM AE là tiếp tuyến. b) Qua D kẻ tiếp tuyến cắt AE tại B. CM AC+BD=AB và tam giác AOB vuông tại O. c) Kẻ EH ⊥ CD tại H. CM AD và BC cắt nhau tại trung điểm EH."',
    'output: {"objects":[{"type":"circle","center":"O"},{"type":"point","name":"E"},{"type":"point","name":"A"},{"type":"point","name":"B"},{"type":"point","name":"H"},{"type":"point","name":"N"},{"type":"line","name":"Cx"},{"type":"line","name":"Dt"},{"type":"segment","points":["C","D"]},{"type":"segment","points":["A","E"]},{"type":"segment","points":["A","D"]},{"type":"segment","points":["B","C"]},{"type":"segment","points":["E","H"]}],"constraints":[{"type":"diameter","circle":"O","points":["C","D"]},{"type":"tangent","at":"C","line":"Cx","circle":"O"},{"type":"on_circle","point":"E","circle":"O"},{"type":"tangent","at":"D","line":"Dt","circle":"O"},{"type":"perpendicular","line1":"EH","line2":"CD"},{"type":"intersection","point":"H","of":["EH","CD"]}],"constructions":[{"type":"intersection","point":"A","of":["l1","Cx"]},{"type":"intersection","point":"B","of":["Dt","AE"]},{"type":"intersection","point":"N","of":["AD","BC"]}],"targets":[{"type":"tangent","line":"AE","circle":"O"},{"type":"equation","expr":"AC+BD=AB"},{"type":"right_angle","at":"O","triangle":["A","O","B"]},{"type":"midpoint","point":"N","segment":["E","H"]}]}',
    "",
    "Example (inscribed triangle):",
    'input: "Cho tam giác ABC nhọn, nội tiếp đường tròn (O). Gọi K sao cho AK là đường kính của (O)."',
    'output: {"objects":[{"type":"circle","center":"O"},{"type":"triangle","points":["A","B","C"]},{"type":"point","name":"K"},{"type":"segment","points":["A","K"]}],"constraints":[{"type":"on_circle","point":"A","circle":"O"},{"type":"on_circle","point":"B","circle":"O"},{"type":"on_circle","point":"C","circle":"O"},{"type":"diameter","circle":"O","points":["A","K"]}],"constructions":[],"targets":[]}',
    "",
    "Example (incenter — 3 angle bisectors):",
    'input: "Cho tam giác có 3 đường phân giác cắt nhau tại K."',
    'output: {"objects":[{"type":"triangle","points":["A","B","C"]},{"type":"point","name":"K"}],"constraints":[{"type":"equal_angle","angles":[["B","A","K"],["K","A","C"]]},{"type":"equal_angle","angles":[["A","B","K"],["K","B","C"]]},{"type":"equal_angle","angles":[["A","C","K"],["K","C","B"]]},{"type":"intersection","point":"K","of":["AK","BK","CK"]}],"constructions":[],"targets":[]}',
    "",
    "Example (altitude from A + median from B + bisector from C — each from a different vertex):",
    'input: "Cho tam giác ABC có đường cao AH, đường trung tuyến BM, đường phân giác CK."',
    'output: {"objects":[{"type":"triangle","points":["A","B","C"]},{"type":"point","name":"H"},{"type":"point","name":"M"},{"type":"point","name":"K"},{"type":"segment","points":["A","H"]},{"type":"segment","points":["B","M"]},{"type":"segment","points":["C","K"]}],"constraints":[{"type":"perpendicular","line1":"AH","line2":"BC"},{"type":"intersection","point":"H","of":["AH","BC"]},{"type":"midpoint","point":"M","of":["A","C"]},{"type":"equal_angle","angles":[["A","C","K"],["K","C","B"]]},{"type":"intersection","point":"K","of":["CK","AB"]}],"constructions":[],"targets":[]}',
  ].join("\n");
}
