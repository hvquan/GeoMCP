...
export const FEW_SHOT_BANK: FewShotExample[] = [
  // ─── Vietnamese examples ──────────────────────────────────────────────────
  {
    ...
    output:
      '{"objects":[{"type":"circle","center":"O"},{"type":"point","name":"E"},{"type":"point","name":"A"},{"type":"point","name":"B"},{"type":"point","name":"H"},{"type":"point","name":"N"},{"type":"line","name":"Cx"},{"type":"line","name":"Dt"},{"type":"segment","points":["C","D"]},{"type":"segment","points":["A","E"]},{"type":"segment","points":["A","D"]},{"type":"segment","points":["B","C"]},{"type":"segment","points":["E","H"]}],"constraints":[{"type":"diameter","circle":"O","points":["C","D"]},{"type":"tangent","at":"C","line":"Cx","circle":"O"},{"type":"on_circle","point":"E","circle":"O"},{"type":"perpendicular","line1":"l1","line2":"CE","through":"O"},{"type":"tangent","at":"D","line":"Dt","circle":"O"},{"type":"perpendicular","line1":"EH","line2":"CD","intersect-at":"H"}],"constructions":[{"type":"intersection","point":"A","of":["l1","Cx"]},{"type":"intersection","point":"B","of":["Dt","AE"]},{"type":"intersection","point":"N","of":["AD","BC"]}],"targets":[{"type":"tangent","line":"AE","circle":"O"},{"type":"statement","text":"AC + BD = AB"},{"type":"right_angle","triangle":"AOB"},{"type":"midpoint","point":"N","segment":["E","H"]}]}',
  },
  {
  ...
  // ─── English examples ─────────────────────────────────────────────────────
  {
    description: "EN: circle + diameter + tangent + perpendicular (words form) + intersection + midpoint target",
    language: "en",
    topics: ["circle", "diameter", "tangent", "perpendicular", "intersection", "point_on_circle", "midpoint"],
    input:
      "Given a circle with center O and diameter CD. Draw a tangent Cx to the circle through C. Let E be a point on the circle with center O. Draw a line through O perpendicular to the segment CE and intersecting the tangent Cx at A. a) Prove that AE is a tangent to the circle with center O. b) Draw a tangent to the circle O at D. This tangent intersects AE at B. Prove that AC + BD = AB and that triangle AOB is right-angled at vertex O. c) Draw EH perpendicular to CD at H. Prove that lines AD and BC intersect at the midpoint of EH.",
    output:
      '{"objects":[{"type":"circle","center":"O"},{"type":"point","name":"E"},{"type":"point","name":"A"},{"type":"point","name":"B"},{"type":"point","name":"H"},{"type":"point","name":"N"},{"type":"line","name":"Cx"},{"type":"line","name":"Dt"},{"type":"segment","points":["C","D"]},{"type":"segment","points":["A","E"]},{"type":"segment","points":["A","D"]},{"type":"segment","points":["B","C"]},{"type":"segment","points":["E","H"]}],"constraints":[{"type":"diameter","circle":"O","points":["C","D"]},{"type":"tangent","at":"C","line":"Cx","circle":"O"},{"type":"on_circle","point":"E","circle":"O"},{"type":"perpendicular","line1":"l1","line2":"CE","through":"O"},{"type":"tangent","at":"D","line":"Dt","circle":"O"},{"type":"perpendicular","line1":"EH","line2":"CD","intersect-at":"H"}],"constructions":[{"type":"intersection","point":"A","of":["l1","Cx"]},{"type":"intersection","point":"B","of":["Dt","AE"]},{"type":"intersection","point":"N","of":["AD","BC"]}],"targets":[{"type":"tangent","line":"AE","circle":"O"},{"type":"statement","text":"AC + BD = AB"},{"type":"right_angle","triangle":"AOB"},{"type":"midpoint","point":"N","segment":["E","H"]}]}',
  },
  {
...
function scoreExample(
  ...
  // Prefer "words form" examples (they match natural-language problem statements better)
  if (ex.description.includes("words form")) score += 1;
  return score;
}
