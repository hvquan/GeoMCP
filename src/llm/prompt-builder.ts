...
const PROMPT_HEADER = [
  ...
  '- AUXILIARY PERPENDICULAR CONSTRUCTION ("Qua O kẻ ⊥ CE cắt Cx tại A", "Through O draw ⊥ to CE, meeting Cx at A"): Use "l1" as the line name. Emit {"type":"perpendicular","line1":"l1","line2":"CE","through":"O"} in constraints. The "through" field names the point the line passes through. Add point A in objects + {"type":"intersection","point":"A","of":["l1","Cx"]} in constructions.',
  '  ex: "Through O draw line ⊥ CE, meeting Cx at A" → constraints:[{"type":"perpendicular","line1":"l1","line2":"CE","through":"O"}] constructions:[{"type":"intersection","point":"A","of":["l1","Cx"]}]',
  ...
  '- PERPENDICULAR FOOT — "Kẻ EH vuông góc với CD tại H" / "Kẻ EH ⊥ CD tại H" / "From E drop a perpendicular to CD at H" / "Draw EH perpendicular to CD at H" / "Dra EH vinkelrät mot CD vid H" / "Dra EH vinkelrätt mot CD vid H":',
  '    Meaning: through point E draw a line perpendicular to CD; this line meets CD at point H. H is the foot of perpendicular from E onto line CD.',
  '    You MUST emit ALL THREE of the following — do NOT skip the constraint:',
  '      objects: {"type":"point","name":"H"}',
  '      objects: {"type":"segment","points":["E","H"]}',
  '      constraints: {"type":"perpendicular","line1":"EH","line2":"CD","intersect-at":"H"}  ← REQUIRED, never omit',
  '    The "intersect-at" field encodes the foot point. NO separate intersection entry is needed.',
  '    ex: "Draw EH perpendicular to CD at H" →',
  '      objects:[{"type":"point","name":"H"},{"type":"segment","points":["E","H"]}]',
  '      constraints:[{"type":"perpendicular","line1":"EH","line2":"CD","intersect-at":"H"}]',
  '- PROBLEMS WITH TWO PERPENDICULARS: When the problem has BOTH (1) "through O draw ⊥ to CE" AND (2) "draw EH ⊥ CD at H", you must emit BOTH perpendicular constraints — they are independent and neither replaces the other:',
  '    constraints must include: {"type":"perpendicular","line1":"l1","line2":"CE","through":"O"}  ← auxiliary line through O',
  '    constraints must include: {"type":"perpendicular","line1":"EH","line2":"CD","intersect-at":"H"}  ← foot of perpendicular from E',
  '    Emitting the l1 perpendicular does NOT satisfy the EH perpendicular — they are different constructions.',
