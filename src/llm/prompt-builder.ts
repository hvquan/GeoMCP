...
const PROMPT_HEADER = [
  ...
  '- TANGENT ("tiếp tuyến tại A", "tangent at A"): {"type":"tangent","at":"A","line":"Ax","circle":"O"}. Put in CONSTRAINTS for given/setup tangents. Put in CONSTRUCTIONS for tangents drawn as explicit construction steps ("draw tangent at D", "qua D kẻ tiếp tuyến"). If line name not given, invent second letter (e.g. "Dt").',
